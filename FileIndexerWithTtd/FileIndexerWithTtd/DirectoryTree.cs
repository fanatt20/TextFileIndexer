...
namespace FileIndexerWithTtd
{
    public class DirectoryTree:IEquatable<DirectoryTree>
    {
        ...
        public List<DirectoryTree> SubDirectories { get { return _subDirectories; } }
        ...
        {
            if(_files.Count != other._files.Count || _subDirectories.Count != other._subDirectories.Count || Name != other.Name)
                return false;
